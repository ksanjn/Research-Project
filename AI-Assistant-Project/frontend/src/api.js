...
// export const predictJobRole = async (userInput) => {
//   try {
//     const response = await fetch(`${BASE_URL}/predict_job_role`, { // Correct API route
//       method: "POST",
//       headers: { "Content-Type": "application/json" },
...
//     if (!response.ok) {
//       throw new Error("Error predicting job role");
//     }

//     return await response.json();
//   } catch (error) {
//     console.error("Error predicting job role:", error);
//     return { message: "Failed to predict job role. Please try again." };
//   }
// };
